...
public class ExamServiceImpl implements ExamService {
    ...
    private TestResponseDto buildFinishedResponse(SessionTest sessionTest, TestRequestDto request, Map<String, Object> lastAnsweredMap) {
        ...
        if ("CEFR".equalsIgnoreCase(request.getSelectedLevel())) {
            String cefrLevel = com.exam.serviceImpl.SessionServiceImpl.assignCefrLevel(score);
    ...
    private java.util.List<TestResponseDto.Option> parseOptions(String optionsJson) {
        ...
        try {
            com.google.gson.reflect.TypeToken<java.util.List<com.exam.dto.SessionTestQuestionDto.Option>> typeToken = new com.google.gson.reflect.TypeToken<java.util.List<com.exam.dto.SessionTestQuestionDto.Option>>(){};
            java.util.List<com.exam.dto.SessionTestQuestionDto.Option> optList = new com.google.gson.Gson().fromJson(optionsJson, typeToken.getType());
            for (com.exam.dto.SessionTestQuestionDto.Option o : optList) {
    ...
    public Map<String, Object> getSessionTest(StatsRequestDto request) {
        ...
        for (com.exam.entities.SessionTestQuestion q : latestTest.getQuestions()) {
        ...
        if (latestTest.getStatus() == com.exam.enums.SessionTestStatus.COMPLETED) {
            ...
            com.exam.entities.AppConfig thresholdConfig = appConfigRepository.findByKey("score_threshold","ai");
            if (thresholdConfig != null && thresholdConfig.getValue() != null) {
                try {
                    threshold = Integer.parseInt(thresholdConfig.getValue());
                } catch (Exception ignored) {}
