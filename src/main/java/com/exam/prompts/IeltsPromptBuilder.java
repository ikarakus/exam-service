...
public class IeltsPromptBuilder extends BasePromptBuilder {

    public IeltsPromptBuilder(String model, String topic, String tutor) {
        super(model, topic, tutor);
    }
    
    public IeltsPromptBuilder(String model, String topic, String tutor, boolean isChildFriendly, String userNickname, String ageRange) {
        super(model, topic, tutor, isChildFriendly, userNickname, ageRange, false);
    }
    
    public IeltsPromptBuilder(String model, String topic, String tutor, boolean isChildFriendly, String userNickname, String ageRange, boolean isFirstMessage) {
    ...
    protected void appendLanguageSpecificInstructions(String language, String languageLevel) {
        // IELTS exam mode
        systemMessage.append("You are an IELTS (International English Language Testing System) exam preparation tutor. ");
        systemMessage.append("You are helping students prepare for the IELTS exam, which focuses on general and academic English across all four skills: reading, writing, listening, and speaking. ");
        ...
        // Conversation flow
        systemMessage.append("Keep the conversation focused on IELTS exam preparation. ");
        ...
        if (isFirstMessage) {
            systemMessage.append("This is the first message. Greet the user warmly and explain that you will help them prepare for the IELTS exam. ");
